...
Extraction is configuration-driven: declare `extractors[]` in `lexicon.json` to
push interface, template, database and content translations by layer. See
[docs/extraction-and-layers.md](docs/extraction-and-layers.md).
