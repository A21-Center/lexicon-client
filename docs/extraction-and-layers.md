...
**Google MT / AI suggestions** are available for **every** layer above. Lexicon
stores suggestions per key/language and can auto-apply or accept them the same
way for interface files, templates, database rows, and CMS content.
